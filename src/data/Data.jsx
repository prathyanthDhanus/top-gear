...
//  ==============!!!!!!!!!!! testmonials data end !!!!!!!!!!!!!!!===================


//  ===================!!!!!!!!!!! horizontal scrolling data !!!!!!!!!!!!!!!===================

export const hScrollData = [
    {
...
//  ===================!!!!!!!!!!! horizontal scrolling data end !!!!!!!!!!!!!!!===================


//  ===================!!!!!!!!!!! carousel images advantage section  !!!!!!!!!!!!!!!===================

 export const carouselmages = [
    {
...
//  ===================!!!!!!!!!!! carousel images advantage section  end !!!!!!!!!!!!!!!===================


//  ===================!!!!!!!!!!! accordionContent faq component  !!!!!!!!!!!!!!!===================
...
//  ===================!!!!!!!!!!! accordionContent faq component   end !!!!!!!!!!!!!!!===================


//  ===================!!!!!!!!!!! card data for service page !!!!!!!!!!!!!!!===================
...
//  ===================!!!!!!!!!!! card data for service page end !!!!!!!!!!!!!!!===================


//  ===================!!!!!!!!!!! horizontal scroll about page !!!!!!!!!!!!!!!===================

export const mechanichScrollData = [ {
    imgSrc: "https://wrench.com/blog/content/images/2020/12/car-mechanic-or-mobile-mechanic.jpg",
    title: "John Doe",
  },
  {
    imgSrc: "https://www.workshopmate.com.au/media/4253/how-to-improve-mechanic-performance-wsm.png",
    title: "Robert Zavier",
  },
  {
    imgSrc:
      "https://www.workbc.ca/sites/default/files/styles/hero_image/public/NTI5NzE_EGmF7XeKRKYBg5rh-7321-NOC.jpg?itok=ZeeGF1xQ",
    title: "Alice White",
  },
  {
    imgSrc:
      "https://everydaypower.com/wp-content/uploads/2023/01/Mechanic-Quotes-That-Will-Inspire-You-To-Work-Hard.jpg",
    title: "Franko Daviz",
  },
  {
    imgSrc:
      "https://www.imagine-america.org/wp-content/uploads/2019/05/top-20-auto-1280x720.png",
    title: "Molly Dizuza",
  },
